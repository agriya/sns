...
/**
 * @ngdoc function
 * @name Sns.controller:trendingController
 * @description
 * # trendingController
 * Controller of the Sns
 */
angular.module('SnsApp')
    .controller('trendingController', ['$scope', '$rootScope', '$location', '$window', '$filter', '$state', 'md5', 'trendingFactory', 'PhotoLikeFactory', 'flash', 'PhotoUnLikeFactory', '$uibModal', '$uibModalStack', function($scope, $rootScope, $location, $window, $filter, $state, md5, trendingFactory, PhotoLikeFactory, flash, PhotoUnLikeFactory, $uibModal, $uibModalStack) {
        $scope.enabled = true;
        ...
        $scope.init = function() {
            ...
            $rootScope.header = $rootScope.settings.SITE_NAME + ' | ' + $filter("translate")("Recent");
            $scope.getPhotos();
        };
        //Get UserPhotos
        $scope.getPhotos = function() {
            ...
            trendingFactory.get(params, function(response) {
                $scope.scroll_flag = true;
