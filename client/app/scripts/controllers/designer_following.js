...
/**
 * @ngdoc function
 * @name Sns.controller:designerFollowingController
 * @description
 * # designerFollowingController
 * Controller of the Sns
 */
angular.module('SnsApp')
    .controller('designerFollowingController', ['$scope', '$rootScope', '$location', '$window', '$filter', 'md5', 'designerfollowingFactory', 'UserUnfollowFactory', 'UserFollowFactory', '$uibModal', 'FlagCategoryFactory', '$uibModalStack', '$state', 'FlickityService', 'UserPhotosFactory', function($scope, $rootScope, $location, $window, $filter, md5, designerfollowingFactory, UserUnfollowFactory, UserFollowFactory, $uibModal, FlagCategoryFactory, $uibModalStack, $state, FlickityService, UserPhotosFactory) {
        ...
        $scope.getUserPhoto = function() {
            ...
            params.sort = 'user_follower_count';
            params.sortby = 'desc';
            params.page = $scope.currentpage;
            designerfollowingFactory.get(params, function(response) {
                $scope.scroll_flag = true;
