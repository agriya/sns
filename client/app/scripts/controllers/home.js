...
/**
 * @ngdoc function
 * @name Sns.controller:HomeController
 * @description
 * # HomeController
 * Controller of the Sns
 */
angular.module('SnsApp')
    .controller('HomeController', ['$scope', '$rootScope', '$location', '$window', '$filter', '$state', 'md5', 'PhotosFactory', 'PhotoLikeFactory', 'flash', 'PhotoUnLikeFactory', '$uibModal', '$uibModalStack', function($scope, $rootScope, $location, $window, $filter, $state, md5, PhotosFactory, PhotoLikeFactory, flash, PhotoUnLikeFactory, $uibModal, $uibModalStack) {
        $scope.enabled = true;
        ...
        $scope.getPhotos = function() {
            ...
            PhotosFactory.get(params, function(response) {
                $scope.scroll_flag = true;
